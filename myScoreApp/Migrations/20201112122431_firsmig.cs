...
namespace myScoreApp.Migrations
{
    public partial class firsmig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "mekanUzakliklari",
                columns: table => new
                {
                    mekanUzaklikId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    mekanUzaklikAdi = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_mekanUzakliklari", x => x.mekanUzaklikId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UzaklikTip = table.Column<string>(nullable: true),
                    mekanAdi = table.Column<string>(nullable: true),
                    mekanAciklamasi = table.Column<string>(nullable: true),
                    mekanResim = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mekanlar_AspNetUsers_userId",
                        column: x => x.userId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mekanId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainComments_mekanlar_mekanId",
                        column: x => x.mekanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainComments_mekanId",
                table: "MainComments",
                column: "mekanId");

            migrationBuilder.CreateIndex(
                name: "IX_mekanlar_userId",
                table: "mekanlar",
                column: "userId");
